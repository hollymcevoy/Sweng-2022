...
declare type OnScreenReactNode = Exclude<ReactNode, boolean | null | undefined>;
/**
 ...
 */
declare type ComponentFactory<TComponentFactoryArguments extends any[], TProps> = (...args: TComponentFactoryArguments) => ((props?: TProps) => OnScreenReactNode) | false;
/**
 * Enhances a UI component through decoration, replacement, or removal.
 */
declare type ComponentEnhancer<TComponentFactoryArguments extends any[], TProps> = (next: ComponentFactory<TComponentFactoryArguments, TProps>) => ComponentFactory<TComponentFactoryArguments, TProps>;
/**
 ...
 * ```
 */
declare type ComponentMiddleware<TSetupArguments extends any[], TComponentFactoryArguments extends any[], TProps> = (...args: TSetupArguments) => ComponentEnhancer<TComponentFactoryArguments, TProps>;
export default ComponentMiddleware;
export { ComponentEnhancer, ComponentFactory };
//# sourceMappingURL=ComponentMiddleware.d.ts.map