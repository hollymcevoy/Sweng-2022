...
var require_event_target_shim = __commonJS({
  "../abort-controller/node_modules/event-target-shim/dist/event-target-shim.js"(exports, module) {
    "use strict";
...
var AbortSignal = class extends import_event_target_shim.EventTarget {
  constructor() {
    super();
