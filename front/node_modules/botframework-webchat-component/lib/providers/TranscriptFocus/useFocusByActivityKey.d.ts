 ...
 */
export default function useFocusByActivityKey(): (activityKey: boolean | string | undefined, withFocus?: boolean) => void;
//# sourceMappingURL=useFocusByActivityKey.d.ts.map